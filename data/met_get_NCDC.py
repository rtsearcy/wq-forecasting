...
outfolder = '/Volumes/GoogleDrive/My Drive/water_quality_modeling/forecasting/data/met/NCDC'
airport_file = os.path.join(outfolder, 'airports_all.csv')  # file with station metadata (see below for necessary columns)

sd = '1999-12-31'  # start date, in YYYY-MM-DD format (account for previous day)
ed = '2021-12-31'  # end date, account for 8hr UTC shift
